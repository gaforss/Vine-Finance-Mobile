...
class ApiService {
  ...
  async updateUser(userData: {
    ...
    try {
      const response: AxiosResponse<{message: string; user: User}> =
        await this.api.post('/auth/api/profile', userData);
  ...
  async getOnboardingSteps(): Promise<ApiResponse<OnboardingStep[]>> {
    try {
      const response: AxiosResponse<OnboardingStep[]> = await this.api.get(
        '/auth/api/onboarding-steps',
      );
      return {success: true, data: response.data};
    } catch (error: any) {
  ...
  async getRealEstate(): Promise<ApiResponse<RealEstate[]>> {
    try {
      ...
      const response: AxiosResponse<RealEstate[]> = await this.api.get(url, {
        params,
      });
      return {success: true, data: response.data};
    } catch (error: any) {
  ...
  async addRealEstate(
    ...
    try {
      const response: AxiosResponse<RealEstate> = await this.api.post(
        '/realestate/add',
        property,
      );
      return {success: true, data: response.data};
  ...
  async updateRealEstate(
    ...
    try {
      const response: AxiosResponse<RealEstate> = await this.api.put(
        `/realestate/update/${id}`,
        property,
      );
      return {success: true, data: response.data};
    } catch (error: any) {
  ...
  async getPropertyDetails(id: string): Promise<ApiResponse<RealEstate>> {
    try {
      const response: AxiosResponse<RealEstate> = await this.api.get(
  ...
  async updateRentCollection(
    propertyId: string,
    month: string,
    data: {collected: boolean; amount?: number},
  ): Promise<ApiResponse<any>> {
    try {
      const response: AxiosResponse<any> = await this.api.put(
        `/realestate/rent/collect/${propertyId}/${month}`,
        data,
      );
      return {success: true, data: response.data};
    } catch (error: any) {
  ...
  async addRentPayment(
    propertyId: string,
    data: {startDate: string; endDate: string; amount: number},
  ): Promise<ApiResponse<any>> {
    try {
      const response: AxiosResponse<any> = await this.api.post(
        `/realestate/rent/pay/${propertyId}`,
        data,
      );
      return {success: true, data: response.data};
    } catch (error: any) {
  ...
  async addRealEstateExpense(
    propertyId: string,
    expense: any,
  ): Promise<ApiResponse<any>> {
    try {
      const response: AxiosResponse<any> = await this.api.post(
        `/realestate/expense/add/${propertyId}`,
        expense,
      );
      return {success: true, data: response.data};
    } catch (error: any) {
  ...
  async listRealEstateExpenses(propertyId: string): Promise<ApiResponse<any>> {
    try {
      const response: AxiosResponse<any> = await this.api.get(
        `/realestate/expense/list/${propertyId}`,
      );
      return {success: true, data: response.data};
    } catch (error: any) {
  ...
  async updateRealEstateExpense(
    ...
    try {
      const response: AxiosResponse<any> = await this.api.put(
        `/realestate/expense/update/${propertyId}/${expenseId}`,
        expense,
      );
      return {success: true, data: response.data};
    } catch (error: any) {
  ...
  // This is for REAL ESTATE expenses
  async deleteRealEstateExpense(
    propertyId: string,
    expenseId: string,
  ): Promise<ApiResponse<any>> {
    try {
      const response: AxiosResponse<any> = await this.api.delete(
        `/realestate/expense/delete/${propertyId}/${expenseId}`,
      );
      return {success: true, data: response.data};
    } catch (error: any) {
  ...
  async listDocuments(propertyId: string): Promise<ApiResponse<any>> {
    try {
      const response: AxiosResponse<any> = await this.api.get(
        `/realestate/${propertyId}/documents`,
      );
      return {success: true, data: response.data};
    } catch (error: any) {
  ...
  async renameDocument(
    ...
    try {
      const response: AxiosResponse<any> = await this.api.put(
        `/realestate/${propertyId}/documents/${docId}`,
        {name},
      );
      return {success: true, data: response.data};
    } catch (error: any) {
  ...
  async getUnits(propertyId: string): Promise<ApiResponse<Unit[]>> {
    try {
      const response: AxiosResponse<Unit[]> = await this.api.get(
        `/realestate/${propertyId}/units`,
      );
      return {success: true, data: response.data};
    } catch (error: any) {
      return this.handleError(error, 'Failed to fetch units');
    }
  }
  ...
  async updateUnit(
    ...
    try {
      const response: AxiosResponse<RealEstate> = await this.api.put(
        `/realestate/${propertyId}/units/${unitId}`,
        unit,
      );
      return {success: true, data: response.data};
    } catch (error: any) {
  ...
  async getCashFlow(period: string = 'monthly'): Promise<ApiResponse<any>> {
    try {
      const response: AxiosResponse<any> = await this.api.get(
        `/plaid/transactions/cashflow?period=${period}`,
      );
      return {success: true, data: response.data};
    } catch (error: any) {
      return this.handleError(error, 'Failed to fetch cash flow data');
    }
  }
  ...
  async getSavingsGoals(): Promise<ApiResponse<SavingsGoal[]>> {
    try {
      const response: AxiosResponse<SavingsGoal[]> = await this.api.get(
        '/api/goals',
      );
      return {success: true, data: response.data};
    } catch (error) {
  ...
  async addSavingsGoal(
    ...
    try {
      const response: AxiosResponse<SavingsGoal> = await this.api.post(
        '/api/goals',
        goal,
      );
      return {success: true, data: response.data};
  ...
  async getSavingsGoalById(id: string): Promise<ApiResponse<SavingsGoal>> {
    try {
      const response: AxiosResponse<SavingsGoal> = await this.api.get(
        `/api/goals/${id}`,
      );
      ...
      return this.handleError(error, 'Failed to fetch savings goal');
    }
  }
  ...
  async updateSavingsGoal(
    ...
    try {
      const response: AxiosResponse<SavingsGoal> = await this.api.put(
        `/api/goals/${id}`,
        goal,
      );
      return {success: true, data: response.data};
  ...
  async getRetirementProjections(): Promise<
    ApiResponse<RetirementProjectionsResult>
  > {
    try {
      const userId = await storageService.getItem('userId');
      if (!userId) {
      ...
      const response = await this.api.get<RetirementProjectionsResult>(
  ...
  async getNetWorthComparison(): Promise<
    ApiResponse<NetWorthComparisonResult>
  > {
    try {
      const userId = await storageService.getItem('userId');
      if (!userId) {
      ...
      const response = await this.api.get<NetWorthComparisonResult>(
        '/retirement/networth/comparison',
        {params: {userId}},
      );
      return {success: true, data: response.data};
    } catch (error) {
  ...
  async updateRetirementGoals(
    ...
    try {
      const response: AxiosResponse<RetirementGoals> = await this.api.put(
        '/retirement/goals',
        goals,
      );
      return {success: true, data: response.data};
  ...
  async createPlaidLinkToken(
    redirectUri?: string,
  ): Promise<ApiResponse<{link_token: string}>> {
    try {
      const response: AxiosResponse<{link_token: string}> = await this.api.post(
  ...
  async updateAccount(
    accountId: string,
    accountData: {name: string; amount: number; category: string},
  ): Promise<ApiResponse<Account>> {
    try {
      const response = await this.api.put(
        `/plaid/manual_account/${accountId}`,
        accountData,
      );
      return {success: true, data: response.data};
    } catch (error) {
